...
2. Key domain objects & locations
...
5. When editing persistence or providers
...
6. Code style & testing expectations
...
9. Examples to consult when implementing changes
