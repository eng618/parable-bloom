  ...
  return (
    <>
      <section className="hero">
        ...
        <Text variant="body">
          A journey of mindfulness, puzzles, and faith. Guide vines through beautiful gardens, uncovering timeless
      ...
      <section className="page">
        ...
        <Text variant="body">
          Parable Bloom isn't just a game; it's a moment of calm in your busy day. Immerse yourself in a world where
          logic meets spiritual reflection.
        </Text>
        <Text variant="body">
        ...
        <ul>
          <li>
            <Text variant="body">Intuitive Gameplay: Simple swipe controls to guide the vines.</Text>
          </li>
          <li>
            <Text variant="body">Beautiful Aesthetics: lush, organic visuals that evolve as you play.</Text>
          </li>
          <li>
            <Text variant="body">Meaningful Narratives: Unlock faith-inspired stories and parables.</Text>
          </li>
          <li>
            <Text variant="body">Offline Play: enjoy the serenity anywhere, anytime.</Text>
          </li>
        </ul>
      </section>
    </>
