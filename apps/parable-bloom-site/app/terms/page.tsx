...
export default function TermsPage() {
  return (
    <article className="page">
      ...
      <Text variant="body">
        By downloading, installing, or using <strong>Parable Bloom</strong> ("App"), you agree to be bound by these <strong>Terms of Service</strong> ("Terms"). If you do not agree to these Terms, please do not use the App. These Terms constitute a binding legal agreement between you and <strong>GVTech</strong> ("we," "us," "our").
      </Text>
      ...
      <ul>
        <li><Text variant="body"><strong>License, sell, rent, lease, assign, distribute, transmit, host, outsource, disclose, or otherwise commercially exploit</strong> the App or make the App available to any third party.</Text></li>
        <li><Text variant="body"><strong>Modify, make derivative works of, disassemble, decrypt, reverse compile, or reverse engineer</strong> any part of the App.</Text></li>
        <li><Text variant="body"><strong>Remove, alter, or obscure</strong> any proprietary notice (including any notice of copyright or trademark) of GVTech or its affiliates, partners, suppliers, or the licensors of the App.</Text></li>
      </ul>
      ...
      <Text variant="body">
        You acknowledge that the App may automatically collect anonymous usage statistics and crash reports ("Telemetry") to assist in the diagnosis of technical issues and the improvement of the user experience, as detailed in our <a href="/privacy">Privacy Policy</a>.
      </Text>

      <Text variant="h2">5. Intellectual Property</Text>
      <Text variant="body">
        The App, including but not limited to all text, graphics, user interfaces, visual interfaces, photographs, trademarks, logos, sounds, music, artwork, and computer code (collectively, "Content"), is owned, controlled, or licensed by or to GVTech, and is protected by trade dress, copyright, patent, and trademark laws, and various other intellectual property rights and unfair competition laws.
      </Text>
