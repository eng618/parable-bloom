...
export default function PrivacyPage() {
  return (
    <article className="page-article animate-fade-in-up">
      ...
      <Text variant="body">
        Our mission is to provide a peaceful, prayerful, and faith-based gaming experience. We believe that your digital peace
        of mind is just as important as your spiritual growth in Christ. Therefore, we design our services to collect the absolute
