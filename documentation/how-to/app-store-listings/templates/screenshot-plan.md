...
- **Notes**: [e.g., Ensure the logo is visible]

### Screenshot 2

- **Visual Focus**: [Second most important feature]
- **Top/Bottom Caption**: [Short punchy text]
- **Notes**: []

### Screenshot 3

- **Visual Focus**: [Third feature]
- **Top/Bottom Caption**: []
- **Notes**: []
...
- **Visual Focus**: [Social proof or secondary feature]
- **Top/Bottom Caption**: [e.g., "Join 10,000+ users."]
- **Notes**: []
